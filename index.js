...
//
const BotName = '-•4尺り1-乃のｲ•-'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/ardhi_xsquerpants'; // Nama Instagramlu cok
const whatsapplu = '0882-9405-2009'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/FrEQ4zgMZG0FMC7VrI7gzK'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/FrEQ4zgMZG0FMC7VrI7gzK'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
